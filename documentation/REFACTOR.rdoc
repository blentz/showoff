...
*Phase 5b: Default Switch (v0.22.0)* - ✓ COMPLETE
* New architecture is now the DEFAULT
* Legacy mode available via +SHOWOFF_USE_LEGACY_SERVER=true+
* Documentation updated for v0.22.0 release
* MIGRATION_GUIDE.md created
* CHANGELOG.txt updated

=== Remaining Work

*Phase 5c (v0.23.0):* Add deprecation warnings for legacy mode
*Phase 5d (v0.24.0):* Remove legacy code path
...
* MIGRATION_GUIDE.md - Migration guide for users upgrading to v0.22.0
